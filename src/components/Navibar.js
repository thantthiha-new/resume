...
const Navibar = () => {
  ...
  return(
    <div>   
      ...
      <a title="Resume" href='https://drive.google.com/file/d/1k5oHVLLr9XAG9ZiTZIFbeGuG_WxCnfhx/view?usp=share_link'target="_blank" rel="noopener noreferrer"><SideBarIcon icon={<IoNewspaperOutline size="30" />} /></a>
